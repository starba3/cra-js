...
export default function InvoiceNewEditForm({ currentInvoice }) {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      DeliveryDate: currentInvoice?.deliveryDate ? new Date(currentInvoice?.deliveryDate) : new Date(),
      installationStatus: currentInvoice?.installationStatus || '',
      installationDate: currentInvoice?.deliveryDate ? new Date(currentInvoice?.installationDate ) : new Date(), 
