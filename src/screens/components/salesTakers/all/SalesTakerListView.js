...
import CollectorTableRow from './SalesTakerTableRow';
import CollectorTableToolbar from './SalesTakerTableToolbar';
...
export default function SalesTakerListView() {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          heading={Translate("salesTakersList")}
          links={[
            // {
            //   name: Translate("app"),
        ...
        >
          ...
          <Button
            onClick={() => navigate(paths.dashboard.salesTakers.create)}
            variant="contained"
    ...
    if (name) {
      inputData = inputData.filter(
        (invoice) =>
          ...
          invoice.lastName.toLowerCase().indexOf(name.toLowerCase()) !== -1 ||
          invoice.email.toLowerCase().indexOf(name.toLowerCase()) !== -1 ||
          invoice.username.toLowerCase().indexOf(name.toLowerCase()) !== -1 
