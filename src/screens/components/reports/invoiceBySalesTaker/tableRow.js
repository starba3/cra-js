...
export default function TableRowNew({
  ...
  const { id, invoiceNo, issueInvoiceDate, invoiceAmount, installationStatus, customerNameEn, customerNameAr, productNameEn, productNameAr, paidStatus, department } = row;
