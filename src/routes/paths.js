...
export const paths = {
  ...
  auth: {
    ...
    jwt: {
      ...
      newPassword: `${ROOTS.AUTH}/jwt/set-password`,
  ...
  dashboard: {
    ...
    collectors: {
      root: `${ROOTS.DASHBOARD}/collectors`,
      list: `${ROOTS.DASHBOARD}/collectors/list`,
      assignEngineer: `${ROOTS.DASHBOARD}/collectors/assignEngineer`,
