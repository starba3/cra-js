...
// Data access
import { getDashboardData, getNeedToActionCount, getInstallationStatusCount } from 'src/data-access/dashboard';
// components
...
import InvoiceCountByStatus from 'src/screens/components/dashboard/headOfEngineer/InvoiceCountByStatus'
...
export default function HOEDashboardView() {
  ...
  useEffect(() => {
    const getNewData = async () => {
      try {
        const newStatusCount = await getInstallationStatusCount(ROLE)
